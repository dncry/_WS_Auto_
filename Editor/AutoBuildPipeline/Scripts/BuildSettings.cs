    ...
    public class BuildSettings : ScriptableObject
{
    ...
    private static List<BuildSettings.OnChangeCallback> onChangeCallbacks = new List<BuildSettings.OnChangeCallback>();
            ...
            if ((UnityEngine.Object) BuildSettings.instance == (UnityEngine.Object) null)
                BuildSettings.instance =
                    AssetDatabase.LoadAssetAtPath<ScriptableObject>(
                            Path.Combine(Path.Combine("Assets", "_WS_Auto_/Editor/AutoBuildPipeline"), "BuildSettings.asset")) as
                        BuildSettings;
            return BuildSettings.instance;
        }
    }
